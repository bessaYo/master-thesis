# scripts/slicing/slice_resnet34.py
...
profile = torch.load("profiles/cifar10_resnet34.pt")
...
# print(f"{'Channel Filter':<30} | {channel_time:>10.3f}s | {'N/A':>10}")
print(f"{'Channel + Block Skip':<30} | {combined_time:>10.3f}s | {'N/A':>10}")